<?php
/**
 * QMS Sheet-25 — Surveillance Audit-1 Notification Letter
 * ACF Group: group_6970c5e51b903
 *
 ...
 *   premises_date: stage2_audit_surveillance_audit_date_surv1 (meta)
...
$subject = 'Surveillance Audit &#8211; 1 reg.';
...
<head>
<meta charset="UTF-8">
<title>Sheet-25 Surveillance Audit-1 Notification</title>
<style>
...
<!-- Body -->
<p class="body-para">
    This is to inform you that <?= $cert_scheme ?>Surveillance Audit &#8211; I shall be conducted at your premises on Dt.&nbsp;&nbsp;<strong><?= $premise_date ?></strong>
</p>
...
<div class="footer">
    ...
    <span class="footer-right">Sheet25 QMS (Version 1.00)</span>
</div>
