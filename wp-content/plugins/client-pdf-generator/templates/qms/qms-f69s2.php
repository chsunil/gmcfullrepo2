<?php
/**
 * QMS – F-69S2: ISO 9001:2015 Surveillance Audit-1 Registration Letter
 * ACF Group: group_955cf0466343
 *
 * All fields are seamless clones (prefix_name=0) — read via get_post_meta():
 *   date       → clone of field_0015 → stage1_intimation_date_yearly_surveillance_intimation_for_s1_&_s2_surv2
...
$letter_date = gmc_format_date(
    get_post_meta( $post_id, 'stage1_intimation_date_yearly_surveillance_intimation_for_s1_&_s2_surv2', true )
);
...
<head>
<meta charset="UTF-8">
<title>F-69S2 Surveillance Audit-1 Registration</title>
<style>
...
<!-- Subject -->
<div class="subject">Sub: <?= $cert_scheme ?>ISO 9001:2015 &#8211; Surveillance Audit &#8211; II &#8211; Registration</div>
