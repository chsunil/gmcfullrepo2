...
/**
 * QMS – F69S1
 * ISO 9001:2015 Surveillance Audit – I – Registration
...
/* ---------------------------------------------
 * Pull ACF Data (from 69s1.json)
 * --------------------------------------------- */
$date     = get_field('date', $post_id) ?: '';
$ref_no   = get_field('ref_no', $post_id) ?: '';
$org_name = get_field('org_name', $post_id) ?: '';
$head_office = get_field('head_office', $post_id) ?: '';
...
<table class="ref-table">
    <tr>
        <td width="50%">Ref No : <?php echo esc_html($ref_no); ?></td>
        <td width="50%">Date : <?php echo esc_html($date); ?></td>
...
<table class="no-border" style="margin-top:12px;">
    ...
    <tr>
        <td><?php echo nl2br(esc_html($org_name)); ?>
        <br>
        <?php echo nl2br(esc_html($head_office)); ?>
        </td>
    </tr>
</table>

<p class="subject">
    Subject : ISO 9001:2015 – Surveillance Audit – I – Registration
</p>
...
<div class="content">
    ...
    <p>
       At the outset, we thank you for choosing GLOBAL MANAGEMENT CERTIFICATION SERVICES									
PVT. LTD. as your Certification Body, we would like to inform you that the annual Surveillance audit									
is due in the month of   		June-2025		Kindly inform us the possible dates so that we can finalize					
the dates with our auditors and the programme for conducting the audit.									
	</p>

    <p>								
We request you to inform us about the changes encountered within your organization with									
respect to Product, Process, Manpower, and Management etc. to enable us to make an									
audit schedule. 									
	</p>

    <p>								
You may provide us the information regarding changes by filling in the enclosed F-22 at the									
earliest to schedule the audit. 									

    </p>

    <p>
       Kindly indicate any reservation or objection regarding members of the team before audit date									
		  </p>

    <p>							
A line of Conformation on the audit dates shall be highly appreciable. Kindly note that 									
surveillance   audits   once   within   every   year is a requirement  for   maintenance of     									
...
<p>Yours faithfully,									
    ...
    <p>
        <strong>For GMC Certification Pvt. Ltd.</strong>
    </p>
