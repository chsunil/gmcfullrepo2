 ...
 *   f16s2ref_no        → proposal_ref_no
 *   f16s2organization  → organization_name
 *   f16s2standard      → cert_scheme
 *   f16s2technical_area → technical_code_area
 *
 * Repeater: f16s2schedule_table (min:4)
 ...
 *
 * Matrix: f16s2AUDIT_PROGRAMME (matrix_flexible)
...
// ── Schedule repeater ─────────────────────────────────────────────────────────
$schedule_rows = get_field( 'f16s2schedule_table', $post_id ) ?: [];

// ── Matrix ────────────────────────────────────────────────────────────────────
$matrix = get_field( 'f16s2AUDIT_PROGRAMME', $post_id );
?><!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<table style="margin-bottom:3px;">
    <tr>
        ...
        <td class="no-border" style="width:18%; font-size:7.5px; vertical-align:top; padding-top:2px;">
            <strong>F-16s2 (Version 2.00, 20.03.2016)</strong><br>QMS Surveillance Year 2
        </td>
    </tr>
</table>
