<?php
/**
 * IMS – F-69S2: Integrated Management System (IMS) Surveillance Audit-2 Registration Letter
 * Based on QMS-F69S2
 */
...
// Letter date — surv2 intimation date
$letter_date = gmc_format_date(
    get_post_meta( $post_id, 'date_yearly_surveillance_intimation_for_s1_&_s2_surv2', true )
);
...
// Surveillance 2 audit date
$surv2_date = gmc_format_date(
    get_post_meta( $post_id, 'date_surv2', true )
);
...
<head>
<meta charset="UTF-8">
<title>F-69 IMS Surveillance Audit-2 Registration</title>
<style>
...
<!-- Subject -->
<div class="subject">Sub: Integrated Management System (<?= $cert_scheme ?>) – Surveillance Audit – II – Registration</div>
...
<p class="body-para">
    A line of confirmation on the audit dates shall be highly appreciable. Kindly note that surveillance audits once within every year is a requirement for maintenance of <strong>Integrated Management System (IMS)</strong> certification.
</p>
...
<div class="footer">
    ...
    <span class="footer-right">F-69S2 IMS (Version 1.00, 12.04.2024)</span>
</div>
