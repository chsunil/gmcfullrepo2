<?php
/**
 * IMS – F-13a Attendance Sheet (Stage-2 / Surveillance)
 * Based on QMS-F13a
 */
...
<table style="margin-bottom:6px;">
    <tr>
        ...
        <td class="no-border title-cell" colspan="<?= $LOGO ? 1 : 2 ?>">
            <strong style="font-size:14px; text-transform:uppercase; letter-spacing:1px;">Attendance Sheet (IMS)</strong><br>
            <span style="font-size:10px; color:#444;">F-13a &nbsp;|&nbsp; Integrated Management System &nbsp;|&nbsp; Version 1.00</span>
        </td>
        <td class="no-border" style="width:22%; font-size:8px; vertical-align:top; padding-top:2px;">
            <strong>F-13a (Version 1.00)</strong><br>IMS Integrated
        </td>
    </tr>
</table>
