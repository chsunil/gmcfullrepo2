<?php
/**
 * IMS Sheet-36 — Surveillance Audit-2 Notification Letter
 * Based on QMS-Sheet36
 */
...
// Subject
$subject = 'IMS Surveillance Audit – 2 Notification';

// Premises on date — surv2 audit date
...
<head>
<meta charset="UTF-8">
<title>IMS Sheet-36 Surveillance Audit-2 Notification</title>
<style>
...
<!-- Body -->
<p class="body-para">
    This is to inform you that <strong>Integrated Management System (<?= $cert_scheme ?>)</strong> Surveillance Audit – II shall be conducted at your premises on Dt.&nbsp;&nbsp;<strong><?= $premise_date ?></strong>
</p>
...
<div class="footer">
    ...
    <span class="footer-right">Sheet-36 IMS (Version 1.00, 12.04.2024)</span>
</div>
