<?php
/**
 * QMS F-14S1 — Confidential Information and No Conflict of Interest Declaration
 *              Surveillance Audit-1
 * ACF Group: group_6970c27c02c1c
 *
 * Seamless clones:
...
// Matrix data
$matrix_data = get_field( 'This_section_shall_be_confirmed_by_Each_audit_team_member_copy', $post_id );
...
$sign_group  = get_field( '_copy', $post_id ) ?: [];
$sign_role   = get_field( 'field_6970c40554e92', $post_id ) ?: ''; // unnamed select inside _copy
...
<head>
<meta charset="UTF-8">
<title>F-14S1 Conflict of Interest Declaration</title>
<style>
...
<table style="margin-bottom:6px;border:none;">
    <tr>
        ...
        <td class="title-cell">
            ...
            <div style="font-size:8pt;margin-top:2px;">Surveillance Audit &#8211; I</div>
        </td>
        <td class="ref-cell">
            <div><span class="lbl">F-14S1 QMS</span></div>
...
<div class="page-footer">F-14S1 QMS (Version 1.00)</div>
