...
<style>
    * { box-sizing: border-box; }
    ...
    .info-val { color: #CC0000; font-weight: bold; }
...
<table class="header-table">
    <tr>
        <td class="header-logo" rowspan="3">
            <img src="<?= $logo_b64 ?>" alt="Global MCS">
        </td>
...
<table class="ft">
    <tr>
        ...
        <td><?= $diff_activities ?></td>
    </tr>
    <tr>
        <td class="lbl-blue" style="vertical-align:top;">Are there any differences between operations of similar sites?</td>
        <td><?= $diff_operations ?></td>
    </tr>
    <tr>
        <td class="lbl-blue" style="vertical-align:top;">No. of sites selected for audit in case of multi sites, Justification on the selection of sites</td>
        <td style="padding:0;">
            <table class="ft" style="margin:0;border:none;">
                <tr>
                    <td style="width:50%;">Sites: (square root one +1 in general situations)</td>
                    <td class="val-italic">n/a</td>
                </tr>
                <tr>
    ...
    <tr>
        ...
        <td>
            <table class="ft" style="margin:0;border:none;">
                <tr>
                    <td style="width:60%;">MD: (Incase remote audit time is more than 30%: Justification-<br>And is it communicated to AB)</td>
    ...
    <tr>
        ...
        <td style="padding:0;">
            <table class="ft" style="margin:0;border:none;">
                <tr>
                    <td style="width:50%;">Incase of Seasonal business</td>
    ...
    <tr>
        <td><table class="ft" style="margin:0;border:none;"><tr>
            <td style="width:50%;">Initial audit to be held in :</td>
            <td style="color:#00AA00;font-weight:bold;"><?= $init_month ?></td>
        </tr></table></td>
    </tr>
    <tr>
        <td><table class="ft" style="margin:0;border:none;"><tr>
            <td style="width:50%;">1st Surveillance in :</td>
            <td style="color:#00AA00;font-weight:bold;"><?= $surv1_month ?></td>
        </tr></table></td>
    </tr>
    <tr>
        <td><table class="ft" style="margin:0;border:none;"><tr>
            <td style="width:50%;">2nd surveillance :</td>
            <td style="color:#00AA00;font-weight:bold;"><?= $surv2_month ?></td>
        </tr></table></td>
    </tr>
    <tr>
        <td><table class="ft" style="margin:0;border:none;"><tr>
            <td style="width:50%;">and Renewal in :</td>
    ...
    <!-- Proposed Audit Team -->
    <tr>
        <td class="lbl-blue" rowspan="6" style="vertical-align:top;">Proposed audit team</td>
        <td style="padding:0;">
            <table class="ft" style="margin:0;border:none;">
                <tr><td style="width:40%;">Team Leader</td><td><?= $team_leader ?></td></tr>
            </table>
        </td>
    </tr>
    <tr>
        <td><table class="ft" style="margin:0;border:none;"><tr>
            <td style="width:40%;">Auditor(s):</td><td><?= $auditors ?></td>
        </tr></table></td>
    </tr>
    <tr>
        <td><table class="ft" style="margin:0;border:none;"><tr>
            <td style="width:40%;">Auditor:</td><td></td>
        </tr></table></td>
    </tr>
    <tr>
        <td><table class="ft" style="margin:0;border:none;">
            <tr><td style="width:40%;">Technical Expert:</td><td><?= $tech_expert ?></td></tr>
            <tr><td>Team Leader under supervision if any/ Witness Auditor:</td><td><?= $tl_supervisor ?></td></tr>
        </table></td>
    </tr>
    <tr>
        <td><table class="ft" style="margin:0;border:none;"><tr>
            <td style="width:40%;">Observers(s):</td><td><?= $observers ?></td>
        </tr></table></td>
    </tr>
    <tr>
        <td><table class="ft" style="margin:0;border:none;"><tr>
            <td style="width:40%;">Interpreter(s):</td><td><?= $interpreters ?></td>
        </tr></table></td>
    </tr>
    ...
    <tr>
        ...
        <td><?= $outsourcing_comp ?></td>
    </tr>

    <!-- Reviewed By -->
    <tr>
        <td class="lbl-blue">Reviewed By:</td>
        <td colspan="1"><?= $rev1_name ?></td>
        <td colspan="2" style="padding:0;"><!-- spacer --></td>
    </tr>
</table>
