...
* MIT License
*
* Customized by Loginfy
*
*/
(function($) {

  function LOGINFYAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  LOGINFYAjaxChosen.prototype.init = function() {
  ...
  LOGINFYAjaxChosen.prototype.events = function() {
  ...
  LOGINFYAjaxChosen.prototype.search_field_focused = function() {
  ...
  LOGINFYAjaxChosen.prototype.search_welcome_message = function() {
  ...
  LOGINFYAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('loginfy-chosen', _this.options.data).done( function( response ) {
  ...
  LOGINFYAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.loginfy-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.LOGINFYChosenOrder($hidden_value, true);
  ...
  $.fn.LOGINFYAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new LOGINFYAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, LOGINFYAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  LOGINFYAbstractChosenOrder = (function() {

    function LOGINFYAbstractChosenOrder() {}

    LOGINFYAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    LOGINFYAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    LOGINFYAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    LOGINFYAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    LOGINFYAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    LOGINFYAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    LOGINFYAbstractChosenOrder.LOGINFYChosenOrder = function(select, order, force) {
    ...
    return LOGINFYAbstractChosenOrder;
  ...
  $.fn.extend({
    LOGINFYChosenOrder: function(order, force) {
      return _LOGINFYChosenOrder.LOGINFYChosenOrder(this, order, force);
    }
  });

  this._LOGINFYChosenOrder = (function(_super) {
    __extends(_LOGINFYChosenOrder, _super);

    function _LOGINFYChosenOrder() {
      _ref = _LOGINFYChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _LOGINFYChosenOrder.relAttributeName = 'data-option-array-index';

    _LOGINFYChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _LOGINFYChosenOrder.getDOMElement = function(element) {
    ...
    _LOGINFYChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _LOGINFYChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _LOGINFYChosenOrder;

  })(LOGINFYAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('loginfy-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('loginfy-depend-on');
        });
...
(function(root, factory) {
  ...
  //
  // Loginfy: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // Loginfy: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectLOGINFY = FormSerializer.serializeObject;
    $.fn.serializeJSONLOGINFY   = FormSerializer.serializeJSON;
  }
