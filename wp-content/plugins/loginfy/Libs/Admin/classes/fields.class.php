 ...
 *
 */
if ( ! class_exists( 'LOGINFY_Fields' ) ) {
  abstract class LOGINFY_Fields extends LOGINFY_Abstract {
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="loginfy-before-text">'. $this->field['before'] .'</div>' : '';
    }

    public function field_after() {

      $output  = ( ! empty( $this->field['after'] ) ) ? '<div class="loginfy-after-text">'. $this->field['after'] .'</div>' : '';
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="loginfy-desc-text">'. $this->field['desc'] .'</div>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<div class="loginfy-help"><span class="loginfy-help-text">'. $this->field['help'] .'</span><i class="fas fa-question-circle"></i></div>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="loginfy-error-text">'. $this->field['_error'] .'</div>' : '';
