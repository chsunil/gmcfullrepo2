 ...
 *
 */
if ( ! class_exists( 'LOGINFY_Abstract' ) ) {
#[AllowDynamicProperties]
abstract class LOGINFY_Abstract {
  ...
  public function __construct() {
    ...
    if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
      ...
      LOGINFY::$css = apply_filters( "loginfy_{$this->unique}_output_css", LOGINFY::$css, $this );
    }
  ...
  public function recursive_output_css( $fields = array(), $combine_field = array() ) {
    ...
    if ( ! empty( $fields ) ) {
      ...
      foreach ( $fields as $field ) {
        ...
        $field_class  = 'LOGINFY_Field_' . $field_type;
