 ...
 *
 */
if ( ! class_exists( 'LOGINFY_Field_link_color' ) ) {
  class LOGINFY_Field_link_color extends LOGINFY_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'loginfy' ),
        'hover'    => esc_html__( 'Hover', 'loginfy' ),
        'active'   => esc_html__( 'Active', 'loginfy' ),
        'visited'  => esc_html__( 'Visited', 'loginfy' ),
        'focus'    => esc_html__( 'Focus', 'loginfy' )
      );
      ...
      foreach ( $color_props as $color_prop_key => $color_prop_value ) {
        ...
        if ( ! empty( $args[$color_prop_key] ) ) {
          ...
          echo '<div class="loginfy--left loginfy-field-color">';
          echo '<div class="loginfy--title">'. esc_attr( $color_prop_value ) .'</div>';
          echo '<input type="text" name="'. esc_attr( $this->field_name( '['. $color_prop_key .']' ) ) .'" value="'. esc_attr( $value[$color_prop_key] ) .'" class="loginfy-color"'. $default_attr . $this->field_attributes() .'/>';
          echo '</div>';
