 ...
 *
 */
if ( ! class_exists( 'LOGINFY_Field_sortable' ) ) {
  class LOGINFY_Field_sortable extends LOGINFY_Fields {
    ...
    public function render() {
      ...
      echo '<div class="loginfy-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="loginfy-sortable-item">';

          echo '<div class="loginfy-sortable-content">';
          ...
          LOGINFY::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="loginfy-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
