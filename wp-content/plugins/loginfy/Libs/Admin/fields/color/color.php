 ...
 *
 */
if ( ! class_exists( 'LOGINFY_Field_color' ) ) {
  class LOGINFY_Field_color extends LOGINFY_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="loginfy-color"'. $default_attr . $this->field_attributes() .'/>';
