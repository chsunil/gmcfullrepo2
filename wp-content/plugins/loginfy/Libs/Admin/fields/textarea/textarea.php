 ...
 *
 */
if ( ! class_exists( 'LOGINFY_Field_textarea' ) ) {
  class LOGINFY_Field_textarea extends LOGINFY_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( LOGINFY::$shortcode_instances ) ) ? LOGINFY::$shortcode_instances : array();
          ...
          foreach ( $shortcodes as $shortcode ) {
            ...
            foreach ( $instances as $instance ) {
              ...
              if ( $instance['modal_id'] === $shortcode ) {
                ...
                echo '<a href="#" class="button button-primary loginfy-shortcode-button" data-modal-id="'. esc_attr( $id ) .'">'. esc_html( $title ) .'</a>';
