(function($) {
    ...
    // Search
    $('.loginfy-search-plugins #search-plugins').on('keyup', function() {
        var value = $(this).val();
...
function activatePlugin(element, file) {
    ...
    jQuery.ajax({
        url: LOGINFYCORE.admin_ajax,
        type: "POST",
        data: {
            action: "jlt_loginfy_recommended_activate_plugin",
            file: file,
            nonce: LOGINFYCORE.recommended_nonce
        },
...
function installPlugin(element, plugin) {
    ...
    jQuery.ajax({
        ...
        type: "POST",
        data: {
            action: "jlt_loginfy_recommended_upgrade_plugin",
            type: 'install',
            plugin: plugin,
            nonce: LOGINFYCORE.recommended_nonce
        },
