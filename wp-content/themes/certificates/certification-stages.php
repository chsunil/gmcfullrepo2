...
function get_certification_stages() {
    return [
        ...
        'ims' => [
            ...
            'draft'   => ['title' => 'Draft',                                                   'group' => 'group_67dc014741369',   'next' => 'f01'],
            'f01'     => ['title' => 'F-01 IMS Application',                                    'group' => 'group_68173ed286e57',   'next' => 'f02'],
            'f02'     => ['title' => 'F-02 IMS Application Review',                             'group' => 'group_f02_technical_review', 'next' => 'f03'],
            'f03'     => ['title' => 'F-03 Certification Agreement',                            'group' => 'group_qms_f03',         'next' => 'f05'],
            'f05'     => ['title' => 'F-05 Audit Team Allocation',                              'group' => 'group_qms_f05',         'next' => 'f14'],
            'f14'     => ['title' => 'F-14 Confidentiality & No Conflict of Interest',          'group' => 'group_qms_f14',         'next' => 'sheet6'],
            'sheet6'  => ['title' => 'Sheet 6 IMS – Stage-1 Audit Notification',               'group' => 'group_qms_sheet6',      'next' => 'f08'],
            'f08'     => ['title' => 'F-08 Audit Schedule (Stage-1)',                           'group' => 'group_qms_f08',         'next' => 'f06'],
            'f06'     => ['title' => 'F-06 Document Review Report',                             'group' => 'group_qms_f06',         'next' => 'f11'],
            'f11'     => ['title' => 'F-11 Invoice / Billing Details',                         'group' => 'group_qms_f11',         'next' => 'f13'],
            'f13'     => ['title' => 'F-13 Corrective Action Request',                         'group' => 'group_qms_f13',         'next' => 'f05a'],
            'f05a'    => ['title' => 'F-05a Audit Team Allocation Plan (Stage-2)',              'group' => 'group_687a08899558e',   'next' => 'f07'],
            'f07'     => ['title' => 'F-07 Certification Assessment Plan',                     'group' => 'group_qms_f07',         'next' => 'sheet12'],
            'sheet12' => ['title' => 'Sheet 12 IMS – Stage-2 Audit Notification',              'group' => 'group_6883495ce8192',   'next' => 'f08a'],
            'f08a'    => ['title' => 'F-08a Audit Schedule (Stage-2)',                         'group' => 'group_6884e410c0ca6',   'next' => 'f09'],
            'f09'     => ['title' => 'F-09 Stage-2 Audit Report',                              'group' => 'group_68850e57b5024',   'next' => 'f12'],
            'f12'     => ['title' => 'F-12 Scope of Certification',                            'group' => 'group_68851d87c8150',   'next' => 'f13a'],
            'f13a'    => ['title' => 'F-13a Attendance Sheet',                                 'group' => 'group_6885acad944c2',   'next' => 'f16'],
            'f16'     => ['title' => 'F-16 Audit Findings',                                    'group' => 'group_6885acfbb64a3',   'next' => 'f17'],
            'f17'     => ['title' => 'F-17 Closing Meeting Minutes',                           'group' => 'group_6885b9609179d',   'next' => 'f24'],
            'f24'     => ['title' => 'F-24 Customer Feedback Form',                            'group' => 'group_692abe113eded',   'next' => 'f48'],
            'f48'     => ['title' => 'F-48 Checklist for Completion of Reports',               'group' => 'group_qms_f48',         'next' => 'f19'],
            'f19'     => ['title' => 'F-19 Checklist for Certification Decision',              'group' => 'group_f19_full',        'next' => 'f15'],
            'f15'     => ['title' => 'F-15 Correspondence & Communication Details',            'group' => 'group_6932f2a846e82',   'next' => 'f25'],
            'f25'     => ['title' => 'F-25 Assessment Check List',                             'group' => 'group_qms_f25',         'next' => 'f10'],
            'f10'     => ['title' => 'F-10 Non-Conformity Report',                             'group' => 'group_696f7f4276d24',   'next' => 'f69'],

            // ── Surveillance Year 1 ───────────────────────────────────────────
            // IMS calls this F69 (QMS calls it F69S1) — same ACF group
            'f69'     => ['title' => 'F-69 IMS Surveillance Audit-1 Reg.',                     'group' => 'group_69707ce350599',   'next' => 'f05s1'],
            'f05s1'   => ['title' => 'F-05 Audit Team Allocation Plan (Surv-1)',               'group' => 'group_6970b191c8d75',   'next' => 'f14s1'],
            'f14s1'   => ['title' => 'F-14 Confidentiality & No COI (Surv-1)',                 'group' => 'group_6970c27c02c1c',   'next' => 'Sheet25'],
            'Sheet25' => ['title' => 'Sheet 25 IMS – Surv-1 Audit Notification',               'group' => 'group_6970c5e51b903',   'next' => 'f08s1'],
            'f08s1'   => ['title' => 'F-08 Audit Schedule (Surv-1)',                           'group' => 'group_6970cd4a77bdc',   'next' => 'f13s1'],
            'f13s1'   => ['title' => 'F-13 Attendance Sheet (Surv-1)',                         'group' => 'group_6974d1c3c4539',   'next' => 'f09s1'],
            // IMS calls this F09S1 (QMS calls it F21S1) — same ACF group
            'f09s1'   => ['title' => 'F-09 Surveillance Audit Report (Surv-1)',                'group' => 'group_6974d4071dadf',   'next' => 'f16s1'],
            'f16s1'   => ['title' => 'F-16 Audit Findings (Surv-1)',                           'group' => 'group_6974d719ef57b',   'next' => 'f17s1'],
            'f17s1'   => ['title' => 'F-17 Closing Meeting Minutes (Surv-1)',                  'group' => 'group_69758381afa73',   'next' => 'f19s1'],
            'f19s1'   => ['title' => 'F-19 Checklist for Certification Decision (Surv-1)',     'group' => 'group_6975847c4afca',   'next' => 'f24s1'],
            'f24s1'   => ['title' => 'F-24 Customer Feedback Form (Surv-1)',                   'group' => 'group_69758615cba4d',   'next' => 'f15s1'],
            'f15s1'   => ['title' => 'F-15 Correspondence & Communication Details (Surv-1)',   'group' => 'group_6975912587e24',   'next' => 'f69s2'],

            // ── Surveillance Year 2 ───────────────────────────────────────────
            'f69s2'   => ['title' => 'F-69 IMS Surveillance Audit-2 Reg.',                     'group' => 'group_955cf0466343',    'next' => 'f05s2'],
            'f05s2'   => ['title' => 'F-05 Audit Team Allocation Plan (Surv-2)',               'group' => 'group_8fa3b08f8716',    'next' => 'f14s2'],
            'f14s2'   => ['title' => 'F-14 Confidentiality & No COI (Surv-2)',                 'group' => 'group_a8577ab07da7',    'next' => 'sheet36'],
            'sheet36' => ['title' => 'Sheet 36 IMS – Surv-2 Audit Notification',               'group' => 'group_bff8a27d39dd',    'next' => 'f08s2'],
            'f08s2'   => ['title' => 'F-08 Audit Schedule (Surv-2)',                           'group' => 'group_cca0f89f58c2',    'next' => 'f13s2'],
            'f13s2'   => ['title' => 'F-13 Attendance Sheet (Surv-2)',                         'group' => 'group_d958093fc637',    'next' => 'f09s2'],
            // IMS calls this F09S2 (QMS calls it F21S2) — same ACF group
            'f09s2'   => ['title' => 'F-09 Surveillance Audit Report (Surv-2)',                'group' => 'group_65cf5ee61153',    'next' => 'f16s2'],
            'f16s2'   => ['title' => 'F-16 Audit Findings (Surv-2)',                           'group' => 'group_e18f7c62d39c',    'next' => 'f17s2'],
            'f17s2'   => ['title' => 'F-17 Closing Meeting Minutes (Surv-2)',                  'group' => 'group_7ce695799b3a',    'next' => 'f19s2'],
            'f19s2'   => ['title' => 'F-19 Checklist for Certification Decision (Surv-2)',     'group' => 'group_b133a3da4e9d',    'next' => 'f15s2'],
            'f15s2'   => ['title' => 'F-15 Correspondence & Communication Details (Surv-2)',   'group' => 'group_f5e9a27b67e6',    'next' => 'f24s2'],
            'f24s2'   => ['title' => 'F-24 Customer Feedback Form (Surv-2)',                   'group' => 'group_d03dadac1197',    'next' => 'f48s2'],

            // ── Final ─────────────────────────────────────────────────────────
            'f48s2'   => ['title' => 'F-48 Checklist for Completion of Reports (Surv-2)',      'group' => 'group_qms_f48',         'next' => null],
...
function get_certification_emails() {
    return [
        ...
        'ims' => [
            ...
            'sheet12' => ['subject' => 'IMS Stage-2 Audit Notification',                     'message' => '<p>Dear {{client_name}},</p><p>Please find attached the Stage-2 Audit Notification.</p><p>Download: <a href="{{pdf_link}}">{{pdf_name}}</a></p><p>Regards,<br/>IMS Team</p>',                     'pdf_field' => 'sheet12_pdf'],
            ...
            'Sheet25' => ['subject' => 'IMS Surv-1 Audit Notification',                      'message' => '<p>Dear {{client_name}},</p><p>Please find attached the Surv-1 Audit Notification.</p><p>Download: <a href="{{pdf_link}}">{{pdf_name}}</a></p><p>Regards,<br/>IMS Team</p>',                      'pdf_field' => 'Sheet25_pdf'],
            ...
            'sheet36' => ['subject' => 'IMS Surv-2 Audit Notification',                      'message' => '<p>Dear {{client_name}},</p><p>Please find attached the Surv-2 Audit Notification.</p><p>Download: <a href="{{pdf_link}}">{{pdf_name}}</a></p><p>Regards,<br/>IMS Team</p>',                      'pdf_field' => 'sheet36_pdf'],
...
function get_certification_pdf() {
    return [
        ...
        'ims' => [
            ...
            'f69', 'f05s1', 'f14s1', 'Sheet25', 'f08s1', 'f13s1', 'f09s1', 'f16s1', 'f17s1', 'f19s1', 'f24s1', 'f15s1',
            // Surveillance S2 — note: f09s2 (not f21s2)
            'f69s2', 'f05s2', 'f14s2', 'sheet36', 'f08s2', 'f13s2', 'f09s2', 'f16s2', 'f17s2', 'f19s2', 'f15s2', 'f24s2',
            // Final completion checklist
            'f48s2'
        ],
    ];
